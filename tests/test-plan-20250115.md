# 🧪 GUILD — Test Plan & Diagnostic Screen (Deliverables D & E)
...
#### 4. Open Chat
**Steps:**
1. Tap on a job → Open chat
2. **Expected:** Chat screen opens, messages load

**Validation:**
- ✅ Chat listener connects
...
**Steps:**
1. Tap attachment icon → Select image
2. **Expected:** Image uploads, message created

**Validation:**
- ✅ Image uploaded to Storage
- ✅ ContentType correct (`image/jpeg`)
- ✅ Message created with URL
- ✅ Image displays in chat

#### 7. Send Video Message
**Steps:**
1. Tap attachment icon → Record video
2. **Expected:** Video uploads, thumbnail generated

**Validation:**
- ✅ Video uploaded (`video/mp4`)
- ✅ Thumbnail generated (`image/jpeg`)
- ✅ Message created with URLs
- ✅ Video plays correctly

#### 8. Send File Message
**Steps:**
1. Tap attachment icon → Select file
2. **Expected:** File uploads, message created

**Validation:**
- ✅ File uploaded with correct contentType
- ✅ Message created with URL
- ✅ File downloadable
...
- ✅ TTL expires after 4.5s
- ✅ Indicator clears on unmount
...
**Validation:**
- ✅ GET `/api/v1/payments/wallet/:userId` succeeds
...
if [ -z "$EXPO_PUBLIC_FIREBASE_API_KEY" ]; then
  echo "⚠️  EXPO_PUBLIC_FIREBASE_API_KEY not set"
fi
...
✅ Backend            Connected (200ms) (2025-01-15 10:30:05)
✅ Socket             Connected (2025-01-15 10:30:06)
✅ Firestore Rules    All checks passed (2025-01-15 10:30:07)
✅ Upload Flow        Image upload OK (2025-01-15 10:30:08)
✅ Chat Listener      Defensive mode active (2025-01-15 10:30:09)
✅ GlobalChatNotif    Service running (2025-01-15 10:30:10)
...
**Status:** Test Plan & Diagnostic Screen complete ✅
