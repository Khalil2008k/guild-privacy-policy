...
const developmentConfig: AdminEnvironmentConfig = {
  ...
  firebaseConfig: {
    ...
    appId: process.env.REACT_APP_FIREBASE_APP_ID || "1:654144998705:web:880f16df9efe0ad4853410",
    measurementId: process.env.REACT_APP_FIREBASE_MEASUREMENT_ID || "G-3F86RQH389"
  },
  features: {
