...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    match /test-triggers/{triggerId} {
      allow read, write: if false; // Dev only
    }
...
1. Wait 10 seconds
2. Restart app
3. Test offer submission - should work!
...
**THIS IS ABSOLUTELY EVERYTHING - NO MORE COLLECTIONS!** 🔥
